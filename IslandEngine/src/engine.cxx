...
void render()
{
    ...
    {
        glProgramUniformMatrix4fv(program.program(), 9, 1, GL_FALSE, &captureView[0][0]);
...
void DrawFrame()
{
    ...
    glBindBuffer(GL_DRAW_INDIRECT_BUFFER, cube_indirect_buffer);
    glDrawArraysIndirect(GL_TRIANGLE_STRIP, nullptr);
